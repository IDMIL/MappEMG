...
if __name__ == "__main__":
    ...
    while True:
        data_proc = tcp_client.get_data_from_server(
            command=["emg_proc"], nb_frame_to_get=1,
        )
        data_raw = tcp_client.get_data_from_server(
            command=["emg_raw_all"], nb_frame_to_get=1,
        )
