...
if __name__ == '__main__':
    # show_cadence = True
    bitalino_interface = BitalinoClient(ip="/dev/tty.BITalino-XX-XX-DevB")
    # def add_device(self, name: str = None, rate: int = 1000, system_rate: int = 100, acq_channels: list = [1,2,3,4,5,6]):
    bitalino_interface.add_device("Bitalino", rate=1000, system_rate=100, acq_channels=[1,2,3,4,5,6])
